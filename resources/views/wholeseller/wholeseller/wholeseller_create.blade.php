...
@section('content')
    ...
    <div class="content-header mb-4">
        <div class="row align-items-center">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">{{ __('Create Wholeseller') }}</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item">
                        <a href="">{{ __('Wholesellers') }}</a>
                    </li>
                    <li class="breadcrumb-item active">{{ __('Create Wholeseller') }}</li>
                </ol>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label for="name">{{ __('Wholeseller Name') }}<span class="required-field">*</span></label>
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="{{ __('Wholeseller Name') }}" value="{{ old('name') }}" required>
                                @error('name')
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> {{ __('Save Wholeseller') }}</button>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-body -->
