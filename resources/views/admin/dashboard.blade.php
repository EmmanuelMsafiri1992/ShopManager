                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-6">
                            <div class="card card-success w-100">
                                <div class="card-header">
                                    ...
                                    <h3 class="card-title">Sales in the last 12 months</h3>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="card card-success w-100">
                                <div class="card-header">
                                    <h3 class="card-title">{{ __('Income & Expenses in last 12 months') }}</h3>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="card card-success">
                                <div class="card-header">
                                    ...
                                    <h3 class="card-title">{{ __('Stock in last 12 months') }}</h3>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="card card-success">
                                <div class="card-header">
                                    ...
                                    <h3 class="card-title">{{ __('Users in last 12 months') }}</h3>
                                </div>
                                <div class="card-body">
